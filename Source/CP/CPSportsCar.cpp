...
#include "CPSportsCar.h"
#include "CPSportsWheelFront.h"
#include "CPSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ACPSportsCar::ACPSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCPSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCPSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCPSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCPSportsWheelRear::StaticClass();
