...
void ACPPlayerController::BeginPlay()
{
	...
	VehicleUI = CreateWidget<UCPUI>(this, VehicleUIClass);
...
void ACPPlayerController::Tick(float Delta)
{
	Super::Tick(Delta);
...
void ACPPlayerController::OnPossess(APawn* InPawn)
{
	Super::OnPossess(InPawn);

	// get a pointer to the controlled pawn
	VehiclePawn = CastChecked<ACPPawn>(InPawn);
}
